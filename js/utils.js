...
function trapFocus(modal) {
  ...
  // 🆕 CREATE NAMED FUNCTION FOR CLEANUP
...
window.hideModal = function() {
  console.log("🔲 Modal closing - running cleanup"); // 🆕 DEBUG LOG
  
  const overlay = document.getElementById('modal-overlay');
  
  // 🆕 RUN CLEANUP BEFORE REMOVAL
  if (overlay && overlay._focusCleanup) {
    overlay._focusCleanup(); // Remove focus trap listeners
  }
...
function showModal(content) {
  console.log("🔲 Modal opened - listeners attached"); // 🆕 DEBUG LOG
